import { romanize } from "$lib/utils/math"
import mlgGlasses from "$lib/assets/icon/player-mlg_glasses.png";
...
const cosmetics: ShopItem[] = [
    { data: { cosmetic: true }, name: "Rainbow Break", id: "enchanted-break", description: "Give Joe some much needed swag", price: 100, dependsOn: "wardrobe" },
    { data: { cosmetic: true }, image: mlgGlasses, name: "Epic Glasses", id: "epic-glasses", description: "Give Joe some much needed swag", price: 100, dependsOn: "wardrobe" },
]
