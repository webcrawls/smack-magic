const testimonial = (name, date, content) => ({ name, date, content, rating: 5.0 })
...
const testimonials = [
    testimonial("Bob A", "November 2008",
        ...
        "seconds. I’ve been smacking away my worries one chop at a time! Thanks Mr. Magic!"),

    testimonial("Susan C", "Feb 2009",
        "<b>Best tool in my kitchen!</b> Don’t know where I’d be without it. Got it as a gift this past " +
        "Christmas and I haven’t looked back since. It's the <b>star of every dinner party</b> and the " +
        "<b>helping hand to every quick, delicious meal</b>!"),
