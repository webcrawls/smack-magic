...
{#snippet title()}
    <h1 style="font-size: 1.5rem">
        As Seen On TV, The Web, And In Your Kitchen!
    </h1>
{/snippet}
...
<SmackMagicWrapper>
    <article class="quote">
        ...
        <div class="text">
            ...
            <br />
            <p>
                The Smack Magic can dice by the smack of the hand, is dishwasher
                safe, made of durable, long lasting materials, and is an overall
                blast!
            </p>
            <br />
            <br />
            ...
            <p style="text-align: end;">
                - <JoeMagic />, CEO of Smack Magic Corp
            </p>
        </div>
    </article>
    ...
    <article class="banner">
        ...
        <p>The Smack Magic is the ideal cutting choice!</p>
        <ul>
            <li>Nuts</li>
            <li>Onions</li>
            <li>Vegetables</li>
    ...
    <article class="banner">
        <h1>SMACK MAGIC's <i>"MAGIC"</i> OFFER</h1>
        <ul>
            <li><h3>2 Smack Magic Vegetable Choppers,</h3></li>
            <li><h3>6 Replacement Blades,</h3></li>
            <li>
                <h3>
        ...
        <h2 style="color: red;">
            Plus, a Special Gift from Joe: <a href="/shop">[ ORDER NOW ]</a>
        </h2>
    </article>
    <article class="card">
        <p>
    ...
    <article class="card" style="align-self: start;">
        <h1><a href="/faq">The SMACK MAGIC F.A.Q.</a></h1>
    </article>
</SmackMagicWrapper>
